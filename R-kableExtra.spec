...
Version  : 1.3.1
Release  : 1
URL      : https://cran.r-project.org/src/contrib/kableExtra_1.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/kableExtra_1.3.1.tar.gz
Summary  : Construct Complex Table with 'kable' and Pipe Syntax
Group    : Development/Tools
License  : MIT
Requires: R-digest
Requires: R-formattable
Requires: R-glue
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609786038
